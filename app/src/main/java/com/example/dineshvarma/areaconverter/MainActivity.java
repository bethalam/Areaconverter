...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names={"Square kilometre","Square metre", "Square mile", "Square yard",
            "Square foot","Square inch", "Hectare", "Acre"};
    double[] values = {1.0, 1000000, 0.38610215854245, 1195990.0463011, 10763910.41671, 1550003100.0062,100, 247.10538146717 };
